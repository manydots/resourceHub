...
- **自定义装备规则**：自定义装备规则配置，规则化定制装备的生成参数
  ![自定义装备规则](screenshot/自定义装备规则.png)

- **自定义装备属性1**：自定义装备属性配置（属性组1）
  ![自定义装备属性1](screenshot/自定义装备属性1.png)

- **自定义装备属性2**：自定义装备属性配置（属性组2）
  ![自定义装备属性2](screenshot/自定义装备属性2.png)

- **自定义装备属性3**：自定义装备属性配置（属性组3）
  ![自定义装备属性3](screenshot/自定义装备属性3.png)
